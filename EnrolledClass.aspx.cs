...
public partial class EnrolledClass : System.Web.UI.Page
{
    ...
    public DataTable GetAllRecord()
    {
        ...
        try
        {
            string sql = "Select c.classId, c.ClassName , c.ClassDescription ,c.ClassStartDate, c.ClassEndDate, c.ClassDays, c.ClassCategory FROM inkclass as c , inkJoinedClass as j Where c.classid =j.ClassId and j.StudentId=  '" + Session["UserId"] + "'  ";
    ...
    protected void CancelClass(int StudentId, int ClassId)
    {
        try
        {
            ...
            {
                sqlcon.Open();
                string query = @"Delete from inkJoinedClass where classid='"+ClassId+"' and studentid='"+StudentId+"';";
